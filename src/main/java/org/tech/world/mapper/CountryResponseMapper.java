...
public class CountryResponseMapper {
    ...
    public static CountryApiResponse fromCountryToCountryResponse(Country country) {
        ...
        countryApiResponse.setCountry_language(country.getCountryLanguage().getLanguage());
